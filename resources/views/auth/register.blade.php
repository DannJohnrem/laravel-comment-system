        ...
        <div class="w-4/12 p-6 bg-white rounded-lg">
            <form action="{{ route('register.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    class="bg-grey-100 border-2 w-full p-4 rounded-lg @error('name') border-red-500 @enderror" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    class="bg-grey-100 border-2 w-full p-4 rounded-lg @error('username') border-red-500 @enderror" value="{{ old('username') }}">
                    @error('username')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
